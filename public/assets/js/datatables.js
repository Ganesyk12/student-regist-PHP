 ...
 *   https://datatables.net/download/#dt/dt-1.13.5/b-2.4.1/b-html5-2.4.1/sb-1.5.0
 *
 * Included libraries:
 *   DataTables 1.13.5, Buttons 2.4.1, HTML5 export 2.4.1, SearchBuilder 1.5.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.5/b-2.4.1/b-html5-2.4.1/sb-1.5.0",
